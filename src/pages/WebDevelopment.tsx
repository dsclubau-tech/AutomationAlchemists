...
const WebDevelopment = () => {
    return (
        <div className="min-h-screen bg-background">
            <SEOHead
                title="Custom Web Development Services | AAlchemists"
                ...
                keywords="web development, custom web app, responsive websites, frontend, backend"
            />
            <SchemaMarkup
                ...
                <div className="container mx-auto px-6 py-32 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-sm sm:text-base md:text-xl text-foreground mb-8 max-w-3xl mx-auto font-display">
                            Expert custom web development services. We build responsive, fast, and scalable web applications tailored to your business needs globally.
                        </p>
                        <Link to="/contact">
                            <Button
                                size="lg"
